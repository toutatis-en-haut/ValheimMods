    ...
    internal static class GatewayConfig
    {
        ...
        public static void Bind(ConfigFile cfg)
        {
            TeleportModifierKey = cfg.Bind(
                "Controls", "TeleportModifierKey", KeyCode.LeftControl,
                "Modifier key held while clicking the map to commit a teleport.");
            ...
            DoubleClickWindowSeconds = cfg.Bind(
                ...
                "Maximum seconds between two clicks for a double-click to register.");
            ...
            RangeCircleColor = cfg.Bind("UI", "RangeCircleColor", new Color(0.5f, 0.8f, 1.0f, 0.45f), "Color of the range circle on the large map.");
